...
\begin{abstract}
    ...
    directions and trends. Additionally, we propose a method which uses
    etymology as context in order to generate definitions for certain polysemous words.
    By using the etymology of the input word, we can generate definitions for some
